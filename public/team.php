    ...
    <div class="row">
        <div class="col-sm-12">
            <ul class="nav nav-tabs">
                <li class="active"><a href="#tab-2014" data-toggle="tab">Team 2014</a></li>
                <li><a href="#tab-2013" data-toggle="tab">Team 2013</a></li>
            </ul>
        </div>
    </div>
    <div class="tab-content">
        <div class="tab-pane fade active in" id="tab-2014">
            <div class="row">
                <div class="col-md-12">
                    <h1>Team 2014</h1>
                </div>
                <div class="col-md-4">
                    <div class="list-group">
                        ...
                        <div class="list-group-item">
                            ...
                            <div class="list-group-item-text">
                                Pranav Kopargaonkar &amp; Shantanu Chauhan
                            </div>
                        </div>
                    ...
                    <div class="list-group">
                        <div class="list-group-item">
                            <h4 class="list-group-item-heading">Management</h4>
                            <div class="list-group-item-text">
                                <strong title="Head">Prateeksha Ramanathan</strong>,
                                Sarang Surve,
                                Ajay Madappat,
                                Venkat Teja K,
                                Farooq Farvez
                ...
                <div class="col-md-4">
                    ...
                    <div class="list-group">
                        <div class="list-group-item">
                            ...
                            <div class="list-group-item-text">
                                <strong title="Head">Hardik Nasit</strong>,
                                Nikunj Patel,
                                Bhargav Dadhaniya,
                                Vaibhav Chaurasya,
                                Aditya Arayan,
                        ...
                        <div class="list-group-item">
                            ...
                            <div class="list-group-item-text">
                                <strong title="Head">Prahalad Singh</strong>,
                                Nikunj Patel,
                                Kanna Dipankar
                            </div>
                        </div>
                        ...
                        <div class="list-group-item">
                            ...
                            <div class="list-group-item-text">
                                <strong title="Head">Shantanu Chauhan</strong>,
                                Ajay Madappat,
                                Jay Sorathia,
                                Rohit Kumar,
                                Ram Charan
                        ...
                        <div class="list-group-item">
                            ...
                            <div class="list-group-item-text">
                                <strong title="Head">Dharmik Kamdar</strong>,
                                Shantanu Chauhan,
                                Sandeep Vempati,
                                Nikhar Jajoo,
                                Harshal Shah
                        ...
                        <div class="list-group-item">
                            ...
                            <div class="list-group-item-text">
                                <strong title="Head">Pranav Kopargaonkar</strong>,
                                Jay Sorathia,
                                Ajay Madappat,
                                Ameer Khan,
                                Harsh Patel J,
                                Amol Mathur,
                                Aakash Umesh Bhanushali
                            </div>
                        </div>
                        ...
                        <div class="list-group-item">
                            ...
                            <div class="list-group-item-text">
                                <strong title="Head">Harsh Patel</strong>,
                                Shaunak Handa,
                                Harshal Shah
                            </div>
                        </div>
        ...
        <div class="tab-pane fade" id="tab-2013">
            <div class="row">
                <div class="col-md-12">
                    <h1>Team 2013</h1>
                </div>
